 ...
 * @var iterable<\App\Model\Entity\Especialidade> $especialidades
 */
...
?>
<div class="especialidades index content">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= h($especialidade->estado) ?></td>
                        <td>
                            <?php if (!empty($cachePermisos[$controller]['leer'])) : ?>
                                <?= $this->Form->create(null, [
                                    'url' => ['action' => 'verEspecialidade', $especialidade->id],
                                    'type' => 'post',
